    ...
    return (
        <div className="min-h-screen bg-bg-primary text-text-primary flex flex-col font-sans">
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        <Link href="/dashboard" className="flex items-center gap-2 group">
                            <div className="w-8 h-8 rounded-lg bg-bg-secondary flex items-center justify-center group-hover:bg-surface-hover transition-colors">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-bg-secondary border border-surface-border text-[11px] font-medium text-action-primary">
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <section className="w-[450px] border-r border-surface-border p-8 overflow-y-auto bg-bg-secondary/80">
                    <div className="mb-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full h-48 bg-bg-primary border border-surface-border rounded-xl p-4 text-sm text-text-primary placeholder:text-text-faded focus:outline-none focus:border-action-primary/50 transition-colors resize-none leading-relaxed"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select className="w-full bg-bg-primary border border-surface-border rounded-lg p-2.5 text-xs text-text-primary focus:outline-none focus:border-action-primary/50">
                        ...
                        >
                            {generating ? (
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 border-2 border-text-on-primary/30 border-t-text-on-primary rounded-full animate-spin"></div>
                                    Generating...
                                </div>
                            ) : "Generate PRD"}
                        </Button>
                        ...
                        <div className="mt-8 pt-8 border-t border-surface-border">
                            ...
                            <div className="space-y-2">
                                {["User Journey Map", "Tech Stack Analysis", "Competitive Landscape"].map(item => (
                                    <div key={item} className="flex items-center justify-between p-3 rounded-lg bg-bg-secondary border border-surface-border hover:border-surface-border cursor-pointer group transition-all">
                                        <span className="text-xs text-text-muted group-hover:text-text-primary">{item}</span>
                                        <div className="w-5 h-5 rounded bg-bg-tertiary flex items-center justify-center text-[10px]">+</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <section className="flex-1 p-8 bg-bg-primary overflow-y-auto relative">
                    {!output && !generating ? (
                        <div className="h-full flex flex-col items-center justify-center max-w-md mx-auto text-center">
                            ...
                            <h3 className="text-xl font-bold text-text-primary mb-3">Awaiting your brilliance</h3>
                        ...
                        <div className="max-w-4xl mx-auto pb-24">
                            {/* Output Toolbar */}
                            <div className="sticky top-0 bg-bg-primary/80 backdrop-blur pb-6 mb-8 flex items-center justify-between border-b border-surface-border z-10">
                                <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                    <Button variant="secondary" size="sm" className="bg-bg-secondary border-surface-border">
                            ...
                            <article className="prose prose-emerald dark:prose-invert max-w-none">
                                {generating ? (
                                    <div className="space-y-6">
                                        <div className="h-10 w-2/3 bg-bg-secondary animate-pulse rounded"></div>
                                        <div className="space-y-3">
                                            <div className="h-4 w-full bg-bg-secondary animate-pulse rounded"></div>
                                            <div className="h-4 w-5/6 bg-bg-secondary animate-pulse rounded"></div>
                                            <div className="h-4 w-4/6 bg-bg-secondary animate-pulse rounded"></div>
                                        </div>
                                        <div className="h-48 w-full bg-bg-secondary animate-pulse rounded-xl"></div>
                                        <div className="h-10 w-1/2 bg-bg-secondary animate-pulse rounded"></div>
                                    </div>
                                ) : (
                    ...
                    {output && !generating && (
                        <div className="absolute bottom-8 right-8 p-4 rounded-xl bg-card/95 backdrop-blur border border-surface-border shadow-2xl max-w-xs animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 rounded-full bg-action-primary/20 flex items-center justify-center text-action-primary">✨</div>
                                <span className="text-sm font-bold text-text-primary">AI Analysis Done</span>
                            </div>
